 ...
 * the browser-runner under §7.1 (real pointerdown/move/up event
...
describe('ColorPicker — SB drag (saturation/value)', () => {
	it.skip('clicking the SB region center changes the value — P3-F11 still blocked after Phase 4', async () => {
...
describe('ColorPicker — Hue drag', () => {
	it.skip('clicking the hue strip changes the hue — P3-F11 still blocked after Phase 4', async () => {
		const calls: string[] = [];
		render(ColorPickerFixture, {
			value: '#ff0000',
			onValueChange: (v: string) => {
