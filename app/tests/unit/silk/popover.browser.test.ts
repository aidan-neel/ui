...
/*
 * Browser-runner justified per strategy §7.1: floating-ui positioning,
 ...
 * not by the initial open prop. Phase 4 fixes this; tests update
 * to mount-with-open-true once the fix lands.
 */
