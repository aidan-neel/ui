...
import { states } from '../../../src/lib/silk/internals/state.svelte.ts';

// Tier 1 + Tier 2 components and fixtures, imported by name.
import Button from '../../../src/lib/silk/components/button/button.svelte';
import Alert from '../../../src/lib/silk/components/alert/alert.svelte';
import Badge from '../../../src/lib/silk/components/badge/badge.svelte';
import Input from '../../../src/lib/silk/components/input/input.svelte';
import Textarea from '../../../src/lib/silk/components/textarea/textarea.svelte';
import Checkbox from '../../../src/lib/silk/components/checkbox/checkbox.svelte';
import Switch from '../../../src/lib/silk/components/switch/switch.svelte';
import Slider from '../../../src/lib/silk/components/slider/slider.svelte';
import Toggle from '../../../src/lib/silk/components/toggle/toggle.svelte';
import Progress from '../../../src/lib/silk/components/progress/progress.svelte';
import Calendar from '../../../src/lib/silk/components/calendar/calendar.svelte';
import Pagination from '../../../src/lib/silk/components/pagination/pagination.svelte';
import Separator from '../../../src/lib/silk/components/separator/separator.svelte';
import Skeleton from '../../../src/lib/silk/components/skeleton/skeleton.svelte';
import Label from '../../../src/lib/silk/components/label/label.svelte';
import Shortcut from '../../../src/lib/silk/components/shortcut/shortcut.svelte';
...
/*
 * SSR tier — strategy §6 and pattern guide §14.2.
 *
