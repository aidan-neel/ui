 ...
 *
 * Extracted from `color-picker.svelte` in Phase 4 item 10 (resolves P3-F3
 * from the findings ledger). Pure functions — no DOM access, no Svelte
 * runes — testable directly via Vitest.
 *
