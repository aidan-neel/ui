 ...
 * 2.0.0 — Phase 4 item 2 a11y fixes: aria-required-children resolved by
 *         moving role="listbox" off Popover.Content (now role="none")
 *         onto the inner combobox-results wrapper with an explicit id
