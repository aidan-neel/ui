...
<header class="flex flex-col gap-5 border-b border-border/60 pb-10">
	...
	<div class="flex flex-col gap-3">
		<h1 class="m-0 text-[2.6rem] font-medium leading-[1] tracking-[-0.035em] md:text-[3rem]" style="font-family: var(--font-header);">Input</h1>
	...
	<div class="relative">
		...
		<div class="overflow-hidden rounded-[var(--radius-lg)] border border-border bg-card shadow-[var(--shadow-sm)]">
			...
			<div class="flex flex-col divide-y divide-border/60">
				...
				<div class="flex flex-col gap-2 px-6 py-4">
					<label for="pg-placeholder" class="text-[0.7rem] font-medium uppercase tracking-wide text-foreground-muted">Placeholder</label>
...
<div class="flex flex-col gap-16 pt-16">
	...
	<section class="scroll-mt-20 flex flex-col gap-5">
		<div class="flex flex-col gap-1">
			<div class="flex items-center gap-2"><span class="grid size-6 place-items-center rounded-md bg-primary/10 text-primary"><Layers size={12} /></span><h2 class="m-0 text-[1.4rem] font-medium tracking-tight" style="font-family: var(--font-header);">Variants</h2></div>
		</div>
