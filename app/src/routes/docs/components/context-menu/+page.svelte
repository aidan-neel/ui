<script lang="ts">
	...
	import * as ContextMenu from '$lib/silk/components/context-menu';
...
<header class="flex flex-col gap-5 border-b border-border/60 pb-10">
	...
	<div class="flex flex-col gap-3">
		<h1 class="m-0 text-[2.6rem] font-medium leading-[1] tracking-[-0.035em] md:text-[3rem]" style="font-family: var(--font-header);">Context Menu</h1>
				...
				<ContextMenu.Trigger>
					<div class="flex items-center gap-3 rounded-[var(--radius-md)] border border-dashed border-border bg-secondary/30 px-3 py-3 cursor-default">
						...
						<div class="flex flex-col">
							<span class="text-[0.84rem] font-medium">brand-guidelines.fig</span>
				...
				<ContextMenu.Trigger>
					<div class="flex flex-col gap-2 rounded-[var(--radius-md)] border border-border bg-background/40 p-3 cursor-default">
						<div class="flex items-center justify-between gap-2">
							<span class="text-[0.7rem] font-medium uppercase text-foreground-muted">SLK-482</span>
						...
						<p class="m-0 text-[0.84rem] font-medium leading-snug">
