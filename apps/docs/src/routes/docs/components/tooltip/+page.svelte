...
<section class="pt-10">
	<div class="relative">
		...
		>
			<div
				class="flex min-h-[12rem] flex-wrap items-center justify-center gap-3 border-b border-border/70 bg-[linear-gradient(135deg,color-mix(in_srgb,var(--color-secondary)_60%,transparent),transparent_70%)] p-8"
			>
