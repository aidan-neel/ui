			...
			<div class="flex flex-col divide-y divide-border/60">
				...
				<div class="flex flex-col gap-2 px-6 py-4">
					...
					<input
						...
						class="h-9 w-full rounded-[var(--radius-md)] border border-border bg-[var(--color-field)] px-3 text-[0.86rem] text-foreground outline-none transition-[border-color,box-shadow] focus:border-[var(--field-focus-border)] focus:shadow-[0_0_0_3px_var(--color-ring)]"
					/>
				</div>
			</div>
